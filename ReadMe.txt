...
Added blank unit test cases for different possible scenarios
...
Added code for the unit test cases to make them pass
...
Added blank unit test cases for rating with and without penalty for all 3 analyser tests
...
Added blank unit test cases for Analyser lookup GetAnalyser for each analyser type and an invalid analyser type as negative test case
...
Added code for the AnalyserLookup unit tests to make them pass

Task 3 Read Canned Data from file

Added blank unit test cases for data reader for different possible scenarios
Added blank unit test cases for each analyser where data is read from file
